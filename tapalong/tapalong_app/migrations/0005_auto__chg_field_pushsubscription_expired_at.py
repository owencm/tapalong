...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PushSubscription.expired_at'
        db.alter_column(u'tapalong_app_pushsubscription', 'expired_at', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'PushSubscription.expired_at'
        db.alter_column(u'tapalong_app_pushsubscription', 'expired_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 2, 28, 0, 0)))
