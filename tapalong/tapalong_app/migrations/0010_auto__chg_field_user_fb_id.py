...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.fb_id'
        db.alter_column(u'tapalong_app_user', 'fb_id', self.gf('django.db.models.fields.BigIntegerField')())

    def backwards(self, orm):

        # Changing field 'User.fb_id'
        db.alter_column(u'tapalong_app_user', 'fb_id', self.gf('django.db.models.fields.IntegerField')())
