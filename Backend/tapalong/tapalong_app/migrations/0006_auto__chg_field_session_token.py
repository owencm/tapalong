...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Session.token'
        db.alter_column(u'tapalong_app_session', 'token', self.gf('django.db.models.fields.BigIntegerField')())

    def backwards(self, orm):

        # Changing field 'Session.token'
        db.alter_column(u'tapalong_app_session', 'token', self.gf('django.db.models.fields.IntegerField')())
