# Django settings for tapalong project.
import os
...
ADMINS = (
    ('Owen Campbell-Moore', 'owencmoore@gmail.com'),
)
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, '../tapalong_app/static'),
...
ROOT_URLCONF = 'tapalong.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'tapalong.wsgi.application'
