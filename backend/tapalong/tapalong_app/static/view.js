...
var view = (function (models) {
  ...
  var TextAreaResizing = React.createClass({
    displayName: 'TextAreaResizing',

    handleChange: function handleChange(e) {
      this.props.onChange(e);
      //     window.setTimeout(function () {
      //       elem.style.height = 'auto';
      //       elem.style.height = elem.
      //    }, 0);
    },
    render: function render() {
      return React.createElement('textarea', { style: { height: this.state.scrollHeight ? this.state.scrollHeight : 'auto' }, onChange: handleChange });
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('input', {
            ...
            required: true }),
          React.createElement('div', { style: { clear: 'both' } }),
          React.createElement(TextAreaResizing, {
            id: 'description',
            style: inputStyle,
