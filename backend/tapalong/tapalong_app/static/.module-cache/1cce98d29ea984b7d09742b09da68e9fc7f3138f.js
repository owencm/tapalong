        ...
        return (
          React.createElement("div", null, 
            React.createElement("div", {style: optionStyle}, 
              React.createElement("a", {onClick: this.state.disabled ? function(){} : this.props.onClick}, 
    ...
    var ActivityBox = React.createClass({displayName: "ActivityBox",
      render: function() {
        ...
        var action = this.props.activity.is_creator ?
          ACTIONS.edit : (this.props.activity.is_attending ? ACTIONS.undoAttend : ACTIONS.attend);
        var actionString = ['Edit', 'Go along', 'Cancel attending'][action];
        var actionClicked = function () {
          if (action == ACTIONS.edit) {
            selectedActivity = activity.id;
            changeState(STATE.edit, {}, true);
          } else if (action == ACTIONS.attend) {
          ...
          } else if (action == ACTIONS.undoAttend) {
            alert('undo attend');
          }
        };
        return (
          React.createElement("section", {style: objectAssign(cardStyle, this.props.activity.is_attending ? attendingStyle : {})}, 
