...
var view = (function (models) {
  ...
  var ActivityBox = React.createClass({displayName: "ActivityBox",
    ...
    render: function() {
      var actionString = ['Edit', 'Go along', 'Cancel attending'][this.state.option];
    ...
    render: function () {
      return (
        React.createElement(Card, null, 
          React.createElement(CardOptions, {options: ['Action']})
        )
      )
    }
  });
  var showCreateActivityForm = function () {
    React.render(
      React.createElement(EditActivity, null),
