...
var view = (function (models) {
  ...
  var ImgFadeInOnLoad = React.createClass({displayName: "ImgFadeInOnLoad",
    ...
    render: function () {
      ...
      return (
        React.createElement("div", {style: {backgroundColor: this.props.backgroundColor, opacity: '1', transition: 'opacity 1s'}}, 
          React.createElement("img", {style: {width: this.props.width, height: this.props.height}})
        )
      )
    }
  })
