...
var view = (function (models) {
  ...
  var redrawActivitiesList = function () {
    var FriendIcon = React.createClass({displayName: "FriendIcon",
      render: function () {
        return (
          React.createElement("img", {src: props.thumbnail, style: friendIconStyle})
        )
      }
    })
    var ActivityBox = React.createClass({displayName: "ActivityBox",
      render: function() {
        ...
        return (
          React.createElement("section", {style: activity.is_attending ? cardStyle : objectAssign(cardStyle, attendingStyle)}, 
            React.createElement("div", {style: {padding: '24px'}}, 
              React.createElement(FriendIcon, {thumbnail: activity.thumbnail}), 
