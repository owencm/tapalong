    ...
    render: function() {
      return (
        React.createElement("div", {className: "planBox"}, 
          "Hello, world! I am a PlanBox for ", this.props.activity.title, "."
        )
      );
    }
  });
  var PlanList = React.createClass({displayName: "PlanList",
    render: function () {
      return models.activities.getActivities().map(function (activity) {
        return React.createElement(PlanBox, {plan: activity});
      });
    }
  });
  console.log('hi');
  React.render(
    React.createElement(PlanList, null),
