...
var view = (function (models) {
  ...
  var ImgFadeInOnLoad = React.createClass({displayName: "ImgFadeInOnLoad",
    ...
    render: function () {
      ...
      return (
        React.createElement("div", {style: {width: this.props.width, height: this.props.height, backgroundColor: this.props.backgroundColor, opacity: '1', transition: 'opacity 1s'}}, 
          React.createElement("img", {style: {width: '100%', height: '100%'}})
        )
      )
    }
  })
