        ...
        return (
          React.createElement("div", null, 
            React.createElement("div", {style: optionStyle}, 
              React.createElement("a", {class: {float: 'right'}}, 
                this.props.option
              )
            ), 
      ...
      render: function() {
        ...
        return (
          React.createElement("section", {style: objectAssign(cardStyle, this.props.activity.is_attending ? attendingStyle : {})}, 
            ...
            React.createElement(CardOptions, {options: [this.props.activity.is_creator ? 'Edit' : (this.props.activity.is_attending ? 'Cancel attending' : 'Go along')]})
          )
        );
      }
    });
