      ...
      return (
        React.createElement(Card, null, 
          React.createElement("div", {style: {padding: '24px'}}, 
            ...
            React.createElement("input", {type: "text", style: inputStyle, className: "input-placeholder-lighter", value: this.props.activity.title, id: "title", placeholder: "Watching Frozen", autoCapitalize: "words", required: true}), 
            React.createElement("input", {type: "date", style: inputStyle, className: "input-placeholder-lighter", id: "date", max: nextWeeksDate, min: todaysDate, value: editing ? timeAndDate.date : tomorrowsDate, required: true}), 
            React.createElement("input", {type: "time", style: inputStyle, className: "input-placeholder-lighter", id: "time", step: "900", value: editing ? timeAndDate.time : '13:00', required: true}), 
