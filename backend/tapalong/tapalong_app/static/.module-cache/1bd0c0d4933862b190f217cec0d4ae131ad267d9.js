  ...
  var redrawActivitiesList = function () {
    var ActivityBox = React.createClass({displayName: "ActivityBox",
      render: function() {
        ...
        var cardTitleString = activity.is_creator ? React.createElement("span", null, React.createElement("b", null, "You"), " are") :
          React.createElement("span", null, React.createElement("b", null, activity.creator_name), " is");
          console.log(cardTitleString);
        // dateInString for starttime
        cardTitleString.push(React.createElement("span", null, React.createElement("b", null, activity.title), " ", activity.start_time));
        var actionType = activity.is_creator ? 'edit' : 'attend';
        var action = activity.is_creator ? 'Edit' : (activity.is_attending ? 'Cancel attending' : 'Go along');
        return (
          React.createElement("section", {class: "card {{#if activity.is_attending}}attending{{/if}}"}, 
