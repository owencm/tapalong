...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tapalong_app_pushsubscription', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('recipient', self.gf('django.db.models.fields.related.ForeignKey')(related_name='push_subscription_set', to=orm['tapalong_app.User'])),
            ('subscription_id', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('expired_at', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
        ))
        db.send_create_signal(u'tapalong_app', ['PushSubscription'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'tapalong_app_pushsubscription')
