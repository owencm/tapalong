...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tapalong_app_user', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'User.name'
        db.alter_column(u'tapalong_app_user', 'name', self.gf('django.db.models.fields.CharField')(max_length=20))
