...
var swLibrary = (function () {
  ...
  var requestPushNotificationPermission = function requestPushNotificationPermission(success) {
    console.log('Requesting push permission');
    Notification.requestPermission(success);
  };

  var requestPushNotificationPermissionAndSubscribe = function requestPushNotificationPermissionAndSubscribe(success) {
  ...
  var sendSubscriptionToServer = function sendSubscriptionToServer(subscriptionObj) {
